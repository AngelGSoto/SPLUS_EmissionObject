...
a iterative $\sigma$-clipped to find the best-fitting as the main stellar locus.
In this order of ideas we made four interactive $\sigma$-clipped.
The objects with a excesses of H{$\alpha$} will be those that considered
above of the final fit.
...
The objects with an H{$\alpha$} excesses will be those that considered above of the
final fit. 
...
objects with a strong blue continuum and another with an intense emission of the continuum
