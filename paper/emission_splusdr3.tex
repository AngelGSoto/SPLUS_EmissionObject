...
Traditionally, color-color diagrams based in H$\alpha$ filter are been used to identify H$\alpha$ emitters for instance Witham used the (r - H$\alpha$) vs (r - i) colour-colour diagram to find for new CV. 
