...
\title[\rlopes{S-PLUS: H$\alpha$ emitters} S-PLUS: Emission line objects]{\rlopes{H$\alpha$ emitters from the Southern Photometric Local Universe Survey (S-PLUS)} Optical identification of emission
...
Figure~\ref{fig:criteria-color-plot} illustrates the procedure used to slected the H{$\alpha$}
