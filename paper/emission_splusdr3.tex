...
\rlopes{There are two ongoing multi-band surveys observing the sky in a systematic, complementary way with 5 broad and 7 narrow-band filters, including H$\alpha$: the Javalambre Photometric Local Universe Survey
...
The narrow-band set include the filter $J0660$ which detect
the H{$\alpha$} plus [N II] emission lines. For more detailed about the configuration of
S-PLUS filter set see Figure~\ref{fig:curves}, which shows the Javalambre filter
...
The current data release contains about 60 millions of objects covering a total
...
particular interest to the third data release of the S-PLUS main survey.
...
\begin{figure}
    ...
    \caption{Transmission curves of the S-PLUS filter set. The narrow-band filter
      ...
      classes of emission line objects, from upper to down;  a PN, a symbiotic star, an extragalactic H II region, a blue compact galaxy,  a YSO, a CV star, a B[e] star, a star forming galaxy and QSO with redshift of XX.}
    \label{fig:curves}
\end{figure}
...
also include the phothometric uncertainties in $r$ - $J0660$ for each individual data source as
...
\includegraphics[width=0.5\linewidth, trim=10 10 10 8, clip]{Figs/spec-0283-51959-0496-SPLUS-n01s20-026220.pdf}  \llap{\raisebox{3.7cm}{\includegraphics[width=0.2\linewidth, trim=200 10 300 30, clip]{Figs/Galaxy_176.35960159169613-0.0041113183584209_150_r.pdf}}} &
  ...
  is responsible for the $J0660$ magnitude. And a Seyfert 1 with $z = 0.317$ (\textit{d}). For this last object, the excess on the $J0660$ is due to the [O III] 4959, 5007 \AA~ emission lines (\textit{d}). As in Figure~\ref{fig:photo-image-knonw-objects} coloured symbols indicate the 
  S-PLUS photometry.}
