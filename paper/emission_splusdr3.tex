...
Witham et el. (2008) present a catalogue of point-sources Hα emission objects identified in IPHAS. 
...
\begin{figure}
	\includegraphics[width=0.9\linewidth, trim=50 115 10 8]{Figs/red-blue-colorObjects-gr.pdf}  \llap{\raisebox{2.9cm}{\includegraphics[width=0.36\linewidth, trim=10 10 -30 0]{Figs/distribution-zg.pdf}}} \lapbox{\raisebox{2.9cm}{\includegraphics[width=0.36\linewidth, trim=52 52 8 8, clip]{Figs/distribution-rg.pdf}}}
    \caption{Emission lines selected...}
    \label{fig:new-color}
\end{figure}
