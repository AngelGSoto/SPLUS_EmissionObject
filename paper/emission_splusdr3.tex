...
\begin{abstract}
  ...
  our list of emitters in two sub-groups: one with intense blue continuum
  and another with intense red one.  
\end{abstract}
...
O star, in the H II regions are formed new stars. Unlike, H II
regions 
...
\newcommand\TableHeader{
  \hline\hline
Id Simbad & \(\mathrm{RA}\) & \(\mathrm{DEC}\) & Type & Group -- {\sc hca} & P(Blue) -- {\sc hdbscan} & P(Red) -- {\sc hdbscan} \\
