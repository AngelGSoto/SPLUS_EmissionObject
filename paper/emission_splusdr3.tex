...
\begin{figure*}
  ...
  \caption{An illustration of the selection criteria used to identify strong
    ...
    fit, it is shown in red (blue). Objects selected as H{$\alpha$} emitters must be located
    above the cut and are shown as large triangles. Note that the cut lines shown here
