...
shows the equation~\ref{eq:criterion}.
...
the S-spectra and corresponding colored image. Figure shows an example of S-spectra in magnitude
unities, clearly this objects display strong H$alpha$ emitter.
