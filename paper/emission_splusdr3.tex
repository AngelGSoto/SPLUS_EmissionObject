...
\title[S-PLUS DR3: Emission line objects]{S-PLUS: Emission line objects in the southern photometric local Universe survey}
...
%% \begin{figure*}
%%   \includegraphics[width=0.9\linewidth]{Figs/halpha-emitters-galactic-aitoff.pdf}
%%   \llap{\raisebox{4.5cm}{\includegraphics[width=0.25\linewidth, trim=10 10 -40 0]{Figs/distribution-bgalactic.pdf}}}
%%     \caption{Emission lines selected...}
