...
We find a total of 389 blue outliers, 336 absorption line candidates
and 1337 emission line candidates in our photometric catalogue.
We show the magnitude and colour distributions of the emission
and absorption line candidates in the left- and right-hand panels
...
a dwarf white \citep{Patterson:1984}. Fig.~\ref{fig:knonw-objects} the SPLUS
...
\subsubsection{QSOs}
Another extragalactic objects with emission lines that were selected are the
QSOS. This category include several class of galaxies according to SIMBAD
