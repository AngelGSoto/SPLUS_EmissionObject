...
%\item \sout{(Por favor tente expressar esse item de uma meneira melhor; eu estou com receio de %mudar e alterar o sentido; depois marque-o, e eu retornarei a esse ponto para ver)} The %selected cluster are used to the label points. Furthermore, the definition
...
of ``soft clustering'' (also known as fuzzy clustering). We have carried out here soft
clustering 
from 
