...
The right panel of Fig.~\ref{fig:hdbscan} shows that the data points that are classified as 
the noise by \texttt{HDBSCAN}  at which the most likely cluster belong.   
