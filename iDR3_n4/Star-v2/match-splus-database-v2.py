...
tab = Table.read("Halpha-DR3_PStotal-STAR_merge-clean-duplicate-coor.ecsv", format="ascii.ecsv")
...
asciifile = "Halpha-DR3_PStotal-STAR_merge-clean-duplicate.ecsv"
merged_table.write(asciifile, format="ascii.ecsv", overwrite=True)
