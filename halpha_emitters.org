...
pattern = "iDR3_n4/LAMOST-spectra-all/*.fits"
file_fits = glob.glob(pattern)
...
tab.write("iDR3_n4/LAMOST-spectra-all/spectra-information-lamost.ecsv", format="ascii.ecsv", overwrite=True)
tab.write("iDR3_n4/LAMOST-spectra-all/spectra-information-lamost.dat", format="ascii.commented_header", overwrite=True)

#+END_SRC

#+RESULTS:
[[file:Data shape: (106, 4)
Number the objects with z < 0.02: 77
Number the objects with z > 0.02: 29
]]
