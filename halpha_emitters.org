...
#+BEGIN_SRC python :return pltfile :results file :results output
  ...
  ax.scatter(bp_rp1, G_abs1, c = colors1, edgecolor=['black'], alpha = 0.7, s = 50, zorder=3, label = r"H$\alpha$ emitters with D $\leq$ 4 kpc")
  ax.scatter(bp_rp2, G_abs2, c = colors2, edgecolor=['black'], alpha = 0.7, s = 50, label = r"H$\alpha$ emitters  with D > 4 kpc")
