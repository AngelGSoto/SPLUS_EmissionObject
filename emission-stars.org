...
#+BEGIN_SRC python :results output
  ...
  # HAC
  tab_hac_blue = Table.read("iDR3_n4/Star-v3/Blue1-Halpha-DR3_PStotal-STAR_total-clean-Final.ecsv", format="ascii.ecsv")
  tab_hac_red = Table.read("iDR3_n4/Star-v3/Red0-Halpha-DR3_PStotal-STAR_total-clean-Final.ecsv", format="ascii.ecsv")
  
  # HDBSCAN
  tab_hdbscan = Table.read("iDR3_n4/Star-v3/Halpha-DR3_PStotal-STAR_total-clean-Final-hdbscan.ecsv", format="ascii.ecsv")
...
#+BEGIN_SRC python :results output :noweb yes
  ...
  mask = np.array([source in idd2 for source in idd1])
...
#+RESULTS:
: Number of HAC blue objecs: 1951
: Number of HDBSCAN blue objecs: 1362
: Number objects in commom: 1191
: % -> 87.44493392070484
...
#+BEGIN_SRC python :results output :noweb yes
  ...
  df = pd.read_csv("iDR3_n4/Star-v3/Blue1-Halpha-DR3_PStotal-STAR_total-clean-Final-simbad.csv")
...
#+BEGIN_SRC python :results output :noweb yes
  ...
  for i in tab_hac_red:
   ...
   mask = np.array([source in idd2 for source in idd1])
   print("Number of HAC blue objecs:", len(tab_hac_red))
   print("Number of HDBSCAN blue objecs:", len(tab_hdbscan_red))
...
#+RESULTS:
: Number of HAC blue objecs: 918
: Number of HDBSCAN blue objecs: 107
: Number objects in commom: 107
: % -> 100.0
